...
- Move the card to **"In Review"** with a comment: what was built, the spec/plan followed, code-review outcome (both passes) + notable fixes, the branch name, fast-path eligibility/ineligibility if evaluated, and any residual risk.
